...
While the support is good for some features, it is still lacking in some areas. During my work, I encountered and signaled three bugs in the compiler, specifically:
