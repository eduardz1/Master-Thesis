...
Fortran remains to this a very popular language for scientific computing, especially in the field of numerical simulations. It has become a staple in @HPC due to its perfomance and the extensive support for numerical libraries and tools. @x-ModernFortran
