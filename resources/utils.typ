...
// #let wavy = underline.with(stroke: wave())
// #let line = wave.with(amplitude: 0pt, offset: 0.2pt, stroke: 0.4pt)
// #let single = underline.with(stroke: line())
// #let double = underline.with(stroke: line(multiple: (1.5pt,)))
// #let triple = underline.with(stroke: line(multiple: (1.5pt, 3pt)))